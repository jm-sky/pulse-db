...
| 005 | [2026-07-30--005--frontend-typecheck-red-on-develop.md](2026-07-30--005--frontend-typecheck-red-on-develop.md) | CI `Frontend` → `Type check` czerwony na `develop`, nie zdiagnozowane | `todo` |
