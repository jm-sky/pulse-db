...
| `074` | `collector_run.kind` += `blocking`/`deadlocks` + `deadlock_cursor` (watermark system_health) | [plan blocking/deadlocks](../../docs/plans/2026-08-05-blocking-deadlocks.md) — Faza 1 element 4 |
